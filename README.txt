To use first unzip the folder, then type in your terminal:
...
You should place a "api.env" file in the folder, the file being in the format:

ncbi_key_1=abc0123abc0123
ncbi_key_2=def4567def4567

You can find api keys in your ncbi account settings.
...
You can adjust the "Threshold" advanced setting if gene recognition doesn't work as you intend.
